...
class _MeetingHistoryState extends State<MeetingHistory> {
  ...
  Future getAppUser() async {
    ...
    final index = participants
        .indexWhere((element) => element["participant"]["user_id"] == userId);
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => Participants(
                          participants: widget.meeting["room_user"])),
                );
              },
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(widget.meeting["status"],
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 12)),
                        ],
                      ),
                      (widget.meeting["status"] == "live")
                          ? MaterialButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      (widget.meeting["status"] == "end")
                          ...
                          : SizedBox(),
                      (widget.meeting["status"] == "live" ||
                              widget.meeting["status"] == "upcoming")
                          ? MaterialButton(
                              color: Colors.red,
                              onPressed: () {
                                endMeeting();
